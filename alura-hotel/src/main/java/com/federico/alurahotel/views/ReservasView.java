...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/com/federico/imagenes/aH-40px.png")));
		...
		txtFechaE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/federico/imagenes/icon-reservas.png")));
		...
		txtFechaS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/com/federico/imagenes/icon-reservas.png")));
...
//Activa el evento, después del usuario seleccionar las fechas se debe calcular el valor de la reserva
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/federico/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/com/federico/imagenes/reservas-img-3.png")));
