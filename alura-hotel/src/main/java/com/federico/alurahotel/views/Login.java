...
import com.federico.alurahotel.controller.LoginController;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/com/federico/imagenes/img-hotel-login-.png")));
		...
		lblNewLabel_1.setIcon(new ImageIcon(Login.class.getResource("/com/federico/imagenes/lOGO-50PX.png")));
...
//
	        ...
	        if(loginController.validateUser(usuario, contrase)){
