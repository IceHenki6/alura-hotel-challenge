...
//	}
	...
	public RegistroHuesped(Reserva reserva) {
		...
		txtFechaN.getCalendarButton().setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/federico/imagenes/icon-reservas.png")));
		...
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/federico/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/com/federico/imagenes/Ha-100px.png")));
